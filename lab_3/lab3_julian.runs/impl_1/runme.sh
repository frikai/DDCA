...
HD_PWD='C:/Users/julix/git/DDCA/lab3_julian/lab3_julian.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopAdder1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopAdder1.tcl -notrace
