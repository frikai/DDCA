...
HD_PWD='C:/Users/julix/git/DDCA/lab3_julian/lab3_julian.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopAdder1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopAdder1.tcl
