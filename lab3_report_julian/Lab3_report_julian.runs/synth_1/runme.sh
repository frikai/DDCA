...
HD_PWD='C:/Users/julix/git/DDCA/lab3_report_julian/Lab3_report_julian.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopAdder.tcl
