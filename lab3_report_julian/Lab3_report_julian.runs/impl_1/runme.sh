...
HD_PWD='C:/Users/julix/git/DDCA/Lab3_report_julian/Lab3_report_julian.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopAdder.tcl -notrace
