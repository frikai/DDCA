...
HD_PWD='C:/Users/julix/git/DDCA/test_project/test_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dim_single_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dim_single_led.tcl -notrace
