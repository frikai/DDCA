...
HD_PWD='C:/Users/julix/git/DDCA/test_project/test_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dim_single_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dim_single_led.tcl
