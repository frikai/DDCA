...
HD_PWD='C:/Users/julix/git/DDCA/Lab_6_report/Lab_6_report.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bad_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bad_ALU.tcl
