...
HD_PWD='C:/Users/julix/git/DDCA/Lab_6_report/Lab_6_report.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bad_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bad_ALU.tcl -notrace
